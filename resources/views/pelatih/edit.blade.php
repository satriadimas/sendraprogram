                        ...
                        <div class="card mb-4">
                            <div class="card-header ">
                                ...
                                Data Table Pelatih
                                    ...
                                    <form action="{{ url('/pelatih/update') }}" method="POST">
                                        @csrf
                                        <div class="form-group row" style=" margin-bottom: 10px;  margin-right: 1px;margin-left: 1px;margin-top: 10px;">
                                            <input type="hidden" name="id" value="{{ $pelatih->id }}"> <br/>
                                            <label for="staticEmail" class="col-sm-2 col-form-label">Nama Materi Tari</label>
                                            <div class="col-sm-10">
                                              <input type="text" name="nama_pelatih" class="form-control"  value="{{ $pelatih->nama_pelatih }} " required>
                                            </div>
                                          </div>
                                          <div class="form-group row" style=" margin-bottom: 10px;  margin-right: 1px;margin-left: 1px;margin-top: 10px;">
                                            <label for="staticEmail" class="col-sm-2 col-form-label">Alamat</label>
                                            <div class="col-sm-10">
                                              <input type="text" name="alamat"  class="form-control"  value="{{ $pelatih->alamat }} " required>
                                            </div>
                                          </div>
                                        ...
                                        <div class="form-group row" style=" margin-bottom: 10px;  margin-right: 1px;margin-left: 1px;margin-top: 10px;">
                                            ...
                                            <div class="col-sm-10">
                                              <input type="text" name="no_telp"  class="form-control"  value="{{ $pelatih->no_telp }} " required>
                                            </div>
                                          </div>
                                 </div>
