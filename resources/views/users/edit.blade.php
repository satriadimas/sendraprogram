                                        ...
                                        <div class="form-group row" style=" margin-bottom: 10px;  margin-right: 1px;margin-left: 1px;margin-top: 10px;">
                                          ...
                                          <div class="form-group row" style=" margin-bottom: 10px;  margin-right: 1px;margin-left: 1px;margin-top: 10px;">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <select class="form-select" id="jenis_kelamin" name="jenis_kelamin" placeholder="Jenis Kelamin" value="{{ $users->jenis_kelamin }}" required>
                                          ...
                                          <div class="form-group row" style=" margin-bottom: 10px;  margin-right: 1px;margin-left: 1px;margin-top: 10px;">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-select" id="keting_id" name="keting_id" required>
                                                    ...
                                                    <option value="{{ $kel->id }}"{{ $kel->id== $users->keting_id? 'selected':'' }}>{{ $kel->nama_kelas }}</option>
                                                 @endforeach
                                                 </select>
                                            </div>
                                          </div>
