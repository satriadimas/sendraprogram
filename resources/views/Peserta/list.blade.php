       ...
       @include('slice.topbar')
        ...
        @endif
                    <div class="container-fluid px-4">
                        ...
                        <a href="{{ url ('/peserta/create')}}" class="btn btn-success " style="width:200px; margin-bottom: 20px" >Tambah</a>
                        <a href="{{ url ('/peserta/downloadPDF')}}" class="btn btn-warning " style="width:200px; margin-bottom: 20px" >Cetak Laporan</a>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tr>
                                        ...
                                        <td> {{ $user->email}} </td>
                                        <td><a href="{{ url ('/peserta/edit',$user->id)}}" class="btn btn-warning" >Lihat History SPP</button></td>
                                        <td><a href="{{ url ('/peserta/edit',$user->id)}}" class="btn btn-primary" >Edit</button></td>
      ...
      <div class="modal-content">
        ...
        <script>
            ...
            function hapusDataAction(){
                window.location.href = "{{ url('/peserta/hapus') }}/"+idHapus;
            }
        </script>
