                        ...
                        <div class="card mb-4">
                            <div class="card-header ">
                                ...
                                Data Table Materi Tari
                                    ...
                                    <form action="{{ url('/matari/store') }}" method="POST">
                                        @csrf

                                        
                                        <div class="form-group row" style=" margin-bottom: 10px;  margin-right: 1px;margin-left: 1px;margin-top: 10px;">
                                            
                                            <label for="staticEmail" class="col-sm-2 col-form-label">Nama Tari</label>
                                            <div class="col-sm-10">
                                              <input type="text" name="nama_tari" class="form-control"  value=" ">
                                            </div>
                                          </div>
                                          <div  class="form-group row" style=" margin-bottom: 10px;  margin-right: 1px;margin-left: 1px;margin-top: 10px;">
                                            <label  for="roles" class="col-sm-2 col-form-label">Kelas</label>
                                            <div class="col-sm-10">
                                            <select  class="form-select" id="keting_id" name="keting_id" autofocus required value="{{ old('role_id') }}">
